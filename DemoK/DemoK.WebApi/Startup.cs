    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddXafWebApi(builder =>
            {
                ...
                builder.Security
                    .UseIntegratedMode(options =>
                    {
                        ...
                        options.UserType = typeof(DemoK.Module.BusinessObjects.ApplicationUser);
                        // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                        // If you use PermissionPolicyUser or a custom user type, comment out the following line:
                        options.UserLoginInfoType = typeof(DemoK.Module.BusinessObjects.ApplicationUserLoginInfo);
                ...
                {
                    application.ApplicationName = "SetupApplication.DemoK";
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                c.SwaggerDoc("v1", new OpenApiInfo
                {
                    Title = "DemoK API",
                    Version = "v1",
                    Description = @"Use AddXafWebApi(options) in the DemoK.WebApi\Startup.cs file to make Business Objects available in the Web API."
                });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "DemoK WebApi v1");
                });
            }
            else
            {
